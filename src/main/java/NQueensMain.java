...
public class NQueensMain {
    public static void main(String[] args) {
        ...
        nqueensproject.NQueens q; //Initialize the NQueens object
        if(num_of_Threads != 0) //Use different NQueens constructor based on the number of threads
            q = new nqueensproject.NQueens(num_of_Queens, num_of_Threads);
        else
            q = new nqueensproject.NQueens(num_of_Queens);
